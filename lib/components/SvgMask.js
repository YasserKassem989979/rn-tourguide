...
import { Animated, Dimensions, Easing, Platform, View, TouchableWithoutFeedback, TouchableOpacity, } from 'react-native';
...
let SvgMask = (() => {
    class SvgMask extends Component {
        ...
        render() {
            ...
            const Wrapper = dismissOnPress ? TouchableOpacity : View;
            return (React.createElement(Wrapper, { style: this.props.style, onLayout: this.handleLayout, pointerEvents: 'none', onPress: () => { }, activeOpacity: 1 },
